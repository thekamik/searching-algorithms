...
int main() {
    ...
    distance = map.dijkstra(startNode, endNode);
    std::cout << "Distance: " << distance << std::endl;

    trace = map.getTrace(startNode, endNode);
    displayTrace(trace);

    // Test Bellman-Ford algorithm
    std::cout << "Bellman-Ford" << std::endl;
    distance = map.bellmanFord(startNode, endNode);
    std::cout << "Distance: " << distance << std::endl;
    ...
    // Test A* algorithm
    std::cout << "A*" << std::endl;
    distance = map.aStar(startNode, endNode);
    std::cout << "Distance: " << distance << std::endl;
